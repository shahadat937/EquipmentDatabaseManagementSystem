...
{
    public class GetAipPendingProcurementsListRequestHandler : IRequestHandler<GetAipPendingProcurementsListRequest, PagedResult<ProcurementDto>>
    {
        ...
        public async Task<PagedResult<ProcurementDto>> Handle(GetAipPendingProcurementsListRequest request, CancellationToken cancellationToken)
        {
