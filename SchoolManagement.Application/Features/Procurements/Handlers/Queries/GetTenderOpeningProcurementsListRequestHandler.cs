...
{
    public class GetTenderOpeningProcurementsListRequestHandler : IRequestHandler<GetTenderOpeningProcurementsListRequest, PagedResult<ProcurementDto>>
    {
        ...
        public async Task<PagedResult<ProcurementDto>> Handle(GetTenderOpeningProcurementsListRequest request, CancellationToken cancellationToken)
        {
            ...
            procurementsQuery = _ProcurementRepository.FilterWithInclude(
                x => x.SentForAIPDate != null && x.AIPApprovalDate != null && x.TenderFloatedDate != null  && x.OfferReceivedDateAndUpdateEvaluation == null && x.SentForContractDate == null && x.ContractSignedDate == null && (x.ProcurementTenderOpenings == null || 
