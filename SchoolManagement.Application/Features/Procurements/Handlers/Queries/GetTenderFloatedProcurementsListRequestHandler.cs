...
{
    public class GetTenderFloatedProcurementsListRequestHandler : IRequestHandler<GetTenderFloatedProcurementsListRequest, PagedResult<ProcurementDto>>
    {
        ...
        public async Task<PagedResult<ProcurementDto>> Handle(GetTenderFloatedProcurementsListRequest request, CancellationToken cancellationToken)
        {
            ...
            procurementsQuery = _ProcurementRepository.FilterWithInclude(
                x => x.SentForAIPDate != null && x.AIPApprovalDate != null && x.TenderFloatedDate != null && x.ContractSignedDate == null  && x.SentForContractDate == null && (x.ProcurementTenderOpenings == null || 
