...
{
    public class GetOfferUnderEvaluationProcurementsListRequestHandler : IRequestHandler<GetOfferUnderEvaluationProcurementsListRequest, PagedResult<ProcurementDto>>
    {
        ...
        public GetOfferUnderEvaluationProcurementsListRequestHandler(ISchoolManagementRepository<Procurement> ProcurementRepository, IMapper mapper, ISchoolManagementRepository<ProcurementBaseSchoolName> ProcurementBaseSchoolNameRepository, ISchoolManagementRepository<ProcurementTenderOpening> ProcurementTenderOpeningRepository, ISchoolManagementRepository<BaseSchoolName> baseSchoolNameRepository)
        {
        ...
        public async Task<PagedResult<ProcurementDto>> Handle(GetOfferUnderEvaluationProcurementsListRequest request, CancellationToken cancellationToken)
        {
            ...
            procurementsQuery = _ProcurementRepository.FilterWithInclude(
                x => x.SentForAIPDate != null && x.AIPApprovalDate != null && x.TenderFloatedDate != null && x.OfferReceivedDateAndUpdateEvaluation!= null  &&  x.SentForContractDate == null &&  x.ContractSignedDate == null 
                && (x.ProcurementTenderOpenings == null ||
                x.ProcurementTenderOpenings.Any(p => p.TenderOpeningDate != null)) &&
                // Search    
