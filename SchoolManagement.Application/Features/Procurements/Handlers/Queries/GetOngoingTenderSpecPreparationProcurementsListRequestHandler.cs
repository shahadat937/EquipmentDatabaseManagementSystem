...
{
    public class GetOngoingTenderSpecPreparationProcurementsListRequestHandler : IRequestHandler<GetOngoingTenderSpecPreparationProcurementsListRequest, PagedResult<ProcurementDto>>
    {
        ...
        public async Task<PagedResult<ProcurementDto>> Handle(GetOngoingTenderSpecPreparationProcurementsListRequest request, CancellationToken cancellationToken)
        {
            ...
            procurementsQuery = _ProcurementRepository.FilterWithInclude(
                x => x.SentForAIPDate != null && x.AIPApprovalDate != null && x.TenderFloatedDate == null && x.ContractSignedDate == null && x.IndentSentDate == null && x.SentForContractDate == null && (x.ProcurementTenderOpenings == null || 
