...
{
    public class GetShipDrowingByAuthorityIdListRequestHandlar : IRequestHandler< GetShipDrowingByAuthorityIdListRequest, PagedResult<ShipDrowingDto>>
    {
        ...
        public GetShipDrowingByAuthorityIdListRequestHandlar(ISchoolManagementRepository<SchoolManagement.Domain.ShipDrowing> ShipDrowingRepository, IMapper mapper)
        {
            _ShipDrowingRepository = ShipDrowingRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<ShipDrowingDto>> Handle(GetShipDrowingByAuthorityIdListRequest request, CancellationToken cancellationToken)
        {
            ...
            IQueryable<SchoolManagement.Domain.ShipDrowing> ShipDrowings = _ShipDrowingRepository.FilterWithInclude(x => x.AuthorityId == request.AuthorityId &&  ((x.BaseSchoolName.SchoolName.Contains(request.QueryParams.SearchText)) || String.IsNullOrEmpty(request.QueryParams.SearchText)), "Authority", "BaseName", "BaseSchoolName");
