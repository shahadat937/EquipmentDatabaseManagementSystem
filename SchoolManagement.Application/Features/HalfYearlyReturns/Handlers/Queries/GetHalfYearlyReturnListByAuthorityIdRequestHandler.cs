...
{
    public class GetHalfYearlyReturnListByAuthorityIdRequestHandler : IRequestHandler<GetHalfYearlyReturnListByAuthorityIdRequest, PagedResult<HalfYearlyReturnDto>>
    {
        ...
        public GetHalfYearlyReturnListByAuthorityIdRequestHandler(ISchoolManagementRepository<HalfYearlyReturn> HalfYearlyReturnRepository, IMapper mapper)
        {
            _HalfYearlyReturnRepository = HalfYearlyReturnRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<HalfYearlyReturnDto>> Handle(GetHalfYearlyReturnListByAuthorityIdRequest request, CancellationToken cancellationToken)
        {
            ...
            IQueryable<HalfYearlyReturn> HalfYearlyReturns = _HalfYearlyReturnRepository.FilterWithInclude(x => x.BaseSchoolName.ShipInformations.Any(x=> x.AuthorityId == request.AuthorityId) && (x.InputPowerSupply.Contains(request.QueryParams.SearchText) || String.IsNullOrEmpty(request.QueryParams.SearchText)), "EquipmentCategory", "EqupmentName", "BaseSchoolName", "ShipEquipmentInfo");
