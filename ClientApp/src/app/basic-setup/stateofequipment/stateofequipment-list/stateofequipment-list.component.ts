...
export class StateOfEquipmentListComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private StateOfEquipmentService: StateOfEquipmentService,private router: Router,private confirmService: ConfirmService) { }
