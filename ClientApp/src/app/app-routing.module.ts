...
const routes: Routes = [
    ...
    children: [
      {
        ...
        canActivate: [AuthGuard],
        data: {
          role: [Role.ShipUser,Role.MasterAdmin,Role.DD,Role.StaffOfficer,Role.DNWNEEOfficeStaff]
        },
        loadChildren: () =>
...

      {
        ...
        canActivate: [AuthGuard],
        data: {
          role: [Role.MasterAdmin,Role.DD,Role.StaffOfficer,Role.DNWNEEOfficeStaff,Role.LOEO,Role.ShipStaff]
        },
        loadChildren: () =>
...

      {
        ...
        canActivate: [AuthGuard],
        data: {
          role: [Role.ShipUser,Role.MasterAdmin,Role.DD,Role.StaffOfficer,Role.LOEO,Role.DNWNEEOfficeStaff,Role.ShipStaff]
        },
        loadChildren: () =>
      ...
      { path: '', redirectTo: '/authentication/signin', pathMatch: 'full' },
      {
        ...
        canActivate: [AuthGuard],
        data: {
          role: [Role.MasterAdmin, Role.SuperAdmin, Role.ShipStaff,Role.LOEO,Role.EXO, Role.DataEntry, Role.DNWNEEOfficeStaff, Role.CO,Role.StaffOfficer, Role.AreaCommander, Role.Director, Role.StaffOfficer, Role.DD, Role.ShipUser, Role.DataEntry],
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
    data: {
      role: [Role.DD,Role.MasterAdmin,Role.SuperAdmin,Role.StaffOfficer,Role.DNWNEEOfficeStaff],
    },
    loadChildren: () =>
