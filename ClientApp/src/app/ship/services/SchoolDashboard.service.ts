...
export class SchoolDashboardService {
  ...
  getRunningCourseDurationByBase(current, baseNameId) {
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-runningCourseDurationByBase?baseNameId='+baseNameId+'&currentDate='+current).pipe(
      map(response => {        
        return response;
      })
    ); 
  ...
  getrunningCourseListBySchool(current, courseTypeId, schoolId) {
    return this.http.get<SpOfficerDetails[]>(this.baseUrl + '/dashboard/get-runningCourseDurationBySchool?courseTypeId='+courseTypeId+'&CurrentDate='+current+'&baseSchoolNameId='+schoolId).pipe(
      map(response => {
  ...
  getRoutineBySchoolId(courseNameId, schoolId) {
    ...
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-routineInfoBySchoolId?courseNameId='+courseNameId+'&baseSchoolNameId='+schoolId).pipe(
      map(response => {
  ...
  getRoutineByCourse(id:number) {
    ...
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-routineInfoByCourse?baseSchoolNameId='+id).pipe(
      map(response => {
  ...
  getInstructorByCourse(id:number) {
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-instructorByCourse?baseSchoolNameId='+id).pipe(
      map(response => { return response;})
    ); 
  }
  getInstructorBySchoolForBase(id:number) {
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-instructorBySchoolForCO?baseNameId='+id).pipe(
      map(response => { return response;})
    ); 
  }
  ...
  getPendingExamEvaluation(id:number) {
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-pendingExamEvaluation?baseSchoolNameId='+id).pipe(
      map(response => {
        return response;
      })
    ); 
  ...
  getShipInformationBySchoolid(baseSchoolNameId) {
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-ship-information-by-baseschoolnameid?baseSchoolNameId='+baseSchoolNameId).pipe(
      map(response => {
        return response;
      })
    ); 
  ...
  getShipEquipListBySchoolid(baseSchoolNameId) {
    return this.http.get<any[]>(this.baseUrl + '/dashboard/get-ship-equip-list-by-baseschoolnameid?baseSchoolNameId='+baseSchoolNameId).pipe(
      map(response => {
        return response;
      })
    ); 
